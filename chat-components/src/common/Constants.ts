...
export const AriaLabels = class {
    ...
    public static readonly NotificationDismiss = "Notification Dismiss";
    public static readonly NotificationCloseChat = "Close chat";
...
export const Texts = class {
    ...
    public static readonly NotificationDismissText = "Dismiss";
    public static readonly NotificationCloseChatText = "Close chat";
    ...
    public static readonly NotificationPaneChatDisconnectTitleText = "Chat disconnected";
    public static readonly NotificationPaneChatDisconnectSubtitleText = "For additional assistance, please close the chat and try again.";
